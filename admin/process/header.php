<?php
session_start();
if(!isset($_SESSION['username'])) echo"<script>window.location='./login_page.php';</script>";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Shoping Mall Admin</title>
                    ...
                    <a href="#">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="media-heading"><strong><?= $_SESSION['username'] ?></strong>
                                </h5>
